...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    'hero.subheadline': 'Gestiono tus campañas de anuncios con foco, claridad y compromiso real. Sin promesas vacías. Con un plan semanal claro.',
    'hero.cta.primary': 'Agendar llamada',
    'hero.cta.secondary': 'Hablar por WhatsApp',
    'hero.microcopy': 'Respondo en menos de 24 horas. Sin compromiso.',
    ...
    // Value proposition
    'value.title': 'Cómo trabajo contigo',
    'value.subtitle': 'Sin jerga técnica. Con claridad y orden.',
    'value.what.title': 'Lo que hago',
    'value.what.1': 'Gestiono y optimizo tus campañas de anuncios en Meta cada semana',
    'value.what.2': 'Defino prioridades claras para cada período',
    'value.what.3': 'Te explico qué funcionó, qué no, y qué vamos a probar',
    'value.what.4': 'Respondo tus dudas rápidamente, sin dejarte esperando',
    ...
    'value.get.4': 'Alguien comprometido con tu crecimiento',
    ...
    'how.step2.desc': 'Reviso tu situación actual y te doy una evaluación honesta.',
    'how.step3.title': 'Propuesta y acuerdo',
    'how.step3.desc': 'Te presento un plan claro con expectativas realistas.',
    ...
    'limited.text1': 'La diferencia de precios refleja las horas de trabajo, la prioridad de atención y los espacios en mi agenda.',
    'limited.text2': 'Trabajo con pocos clientes para garantizar dedicación real.',
    'limited.honest': 'Nota honesta: Los resultados dependen de muchos factores más allá de la publicidad: tu producto, tu stock, tu oferta, tu operación. No puedo garantizar ventas específicas, pero sí puedo garantizar mi compromiso, claridad y trabajo profesional.',
    
    // FAQ
    'faq.title': 'Preguntas frecuentes',
    'faq.q1': '¿El gasto en anuncios está incluido?',
    'faq.a1': 'No. Mi tarifa cubre la gestión y optimización. El presupuesto de anuncios se paga directamente a Meta y lo defines tú.',
    ...
    'faq.q4': '¿Puedo trabajar contigo si ya tengo un equipo o agencia?',
    'faq.a4': 'Sí, pero necesitamos coordinarnos bien. Puedo trabajar como consultor externo o tomar la gestión directa según lo que funcione mejor.',
    'faq.q5': '¿Qué necesitas de mi parte para empezar?',
    ...
    'faq.a6': 'Porque prefiero hacer bien el trabajo con pocos clientes que hacer trabajo mediocre con muchos. Mi tiempo es limitado y tu inversión merece atención real.',
    'faq.q7': '¿Cómo empiezo?',
    'faq.a7': 'Agenda una llamada o escríbeme por WhatsApp. Conversamos, veo si puedo ayudarte, y si tiene sentido, te presento una propuesta.',
    
    // Final CTA
    'final.title': '¿Listo para ordenar tu publicidad?',
  ...
  en: {
    ...
    'hero.subheadline': 'I manage your ad campaigns with focus, clarity, and real commitment. No empty promises. With a clear weekly plan.',
    'hero.cta.primary': 'Book a call',
    'hero.cta.secondary': 'Chat on WhatsApp',
    'hero.microcopy': 'I respond within 24 hours. No commitment.',
    ...
    // Value proposition
    'value.title': 'How I work with you',
    'value.subtitle': 'No technical jargon. With clarity and order.',
    'value.what.title': 'What I do',
    'value.what.1': 'I manage and optimize your Meta ad campaigns every week',
    'value.what.2': 'I define clear priorities for each period',
    'value.what.3': 'I explain what worked, what did not, and what we will test next',
    'value.what.4': 'I answer your questions quickly, without leaving you waiting',
    ...
    'value.get.4': 'Someone committed to your growth',
    ...
    'how.step2.desc': 'I review your current situation and give you an honest assessment.',
    'how.step3.title': 'Proposal and agreement',
    'how.step3.desc': 'I present a clear plan with realistic expectations.',
    ...
    'limited.text1': 'Price differences reflect work hours, attention priority, and availability in my schedule.',
    'limited.text2': 'I work with few clients to guarantee real dedication.',
    'limited.honest': 'Honest note: Results depend on many factors beyond advertising: your product, your stock, your offer, your operation. I cannot guarantee specific sales, but I can guarantee my commitment, clarity, and professional work.',
    
    // FAQ
    'faq.title': 'Frequently asked questions',
    'faq.q1': 'Is ad spend included?',
    'faq.a1': 'No. My fee covers management and optimization. The ad budget is paid directly to Meta and you define it.',
    ...
    'faq.a4': 'Yes, but we need to coordinate well. I can work as an external consultant or take direct management depending on what works best.',
    ...
    'faq.a6': 'Because I prefer to do good work with few clients than mediocre work with many. My time is limited and your investment deserves real attention.',
    'faq.q7': 'How do I start?',
    'faq.a7': 'Schedule a call or write me on WhatsApp. We talk, I see if I can help you, and if it makes sense, I present a proposal.',
